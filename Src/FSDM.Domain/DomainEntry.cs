...
using FSDM.Domain.CommandHandlers;
...
namespace FSDM.Domain
{
    public class DomainEntry
    {
        ...
        private CommandDispatcher CreateCommandDispatcher(IDomainRepository domainRepository, IEnumerable<Action<ICommand>> preExecutionPipe, IEnumerable<Action<object>> postExecutionPipe)
        {
            ...
            var networkDeviceCommandHandler = new NetworkDeviceCommandHandler(domainRepository);
            commandDispatcher.RegisterHandler<CreateNetworkDevice>(networkDeviceCommandHandler);
            commandDispatcher.RegisterHandler<SetNetworkDeviceInactive>(networkDeviceCommandHandler);
            commandDispatcher.RegisterHandler<SetNetworkDeviceActive>(networkDeviceCommandHandler);
